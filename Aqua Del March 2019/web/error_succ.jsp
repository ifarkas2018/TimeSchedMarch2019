                            ...
                            <div class="col">
                                ...
                                <%
                                    ...
                                    if (sMessage.equalsIgnoreCase("ERR_DB")){
                                        ...
                                        out.print("The book from that author doesn't exist in the database!"); 
                                        ...
                                        out.print("An error occurred while deleting the book from the database!");
                                    } else if (sMessage.equalsIgnoreCase("DEL_NO_BOOK")) {
                                        out.print("The book doesn't exist in the database and it couldn't deleted!");
